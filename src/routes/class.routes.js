...
const classRoutes = [
  ...
  },
  {
    ...
    handler: [ClassController.getClasses],
  },
  {
    method: 'get',
    path: '/:id',
  ...
  },
  {
    ...
    handler: [ClassService.changeCapacity],
  },
  {
    method: 'delete',
    path: '/:id/delete',
  ...
  },
  {
    ...
    handler: [ClassService.addStudentsToClass],
  },
  {
    method: 'patch',
    ...
    handler: [ClassService.removeStudentFromClass],
  },
];
