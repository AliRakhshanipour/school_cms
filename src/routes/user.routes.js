...
const userRoutes = [
  ...
  },
  {
    method: 'patch',
    path: '/:id/change-role',
    middlewares: [isAuthenticated, ensureRolesOrSuperuser()],
    handler: [UserService.changeUserRole],
  },
  {
    method: 'post',
    path: '/upload-profile-picture',
    middlewares: [isAuthenticated, profileUploader.single('profilePicture')],
    handler: [UserService.updateProfilePicture],
  },
];
