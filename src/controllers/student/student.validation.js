...
export const studentSchema = Joi.object({
  ...
  father_education: Joi.string()
    .valid('diplom', 'bachelor', 'master', 'phd', 'others')
    .required()
    .messages({
      'string.empty': 'Father education is required',
      'any.required': 'Father education is required',
      'any.only':
        'Father education must be one of diplom, bachelor, master, phd, or others',
    }),
  mother_education: Joi.string()
    .valid('diplom', 'bachelor', 'master', 'phd', 'others')
    .required()
    .messages({
      ...
      'any.only':
        'Mother education must be one of diplom, bachelor, master, phd, or others',
    }),
