 ...
 *       400:
 *         description: Bad request due to invalid input or existing user
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 *                 message:
 *                   type: string
 *                   example: "Username, email, or phone number already exists"
 *       500:
 ...
 *       400:
 *         description: Bad request due to invalid OTP or phone number
 *         content:
 *           application/json:
 *             schema:
 *               type: object
